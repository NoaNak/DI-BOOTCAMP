      ...
      n.inlinesvg)(".inlineSvgFile", (t=>{
          ...
          const r = ()=>{
              3 === e.length + 1 && setTimeout((()=>{
                  ...
                  document.querySelector('a[aria-label="npm"]').setAttribute("href", "https://www.npmjs.com/~dunks1980"),
                  document.querySelector('a[aria-label="github"]').setAttribute("href", "https://github.com/Dunks1980/"),
                  document.querySelector('a[aria-label="email"]').setAttribute("href", "mailto:info@dunks1980.com?subject=Mail from dunks1980.com")
              }
              ), 50)
          }
          ;
